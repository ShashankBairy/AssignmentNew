              ...
              <section>
                <div className="row gx-4 gy-4">
                            ...
                            <div className="col-12 col-sm-6 col-lg-3">
                                <div className=" shadow-sm h-100 position-relative px-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">{data.ipe_marks||"N/A"}</p>
                            ...
                            <div className="col-12 col-sm-6 col-lg-3">
                                <div className=" shadow-sm h-100 position-relative px-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">{data.recent_marks || "N/A"}</p>
                                        <p className="text-success">+8.6% Up from Section</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-12 col-sm-6 col-lg-3">
                                <div className=" shadow-sm h-100 position-relative px-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">{data.emcet_mock_test || "N/A"}</p>
                            ...
                            <div className="col-12 col-sm-6 col-lg-3 ">
                                <div className=" shadow-sm h-100 position-relative px-2">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">{data.attendance || "N/A"}</p>
                                        <p className="text-danger">-4.3% Down from Section</p>
                                    </div>
                                </div>
                            </div>
