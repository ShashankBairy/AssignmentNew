...
const validationSchema = Yup.object({
  ...
  booksForClass: Yup.string().required('Books for Class is required'),
          ...
          <Form>
            ...
            >
              ...
              <div className="row mb-3" style={{ marginTop: '40px' }}>
                {/* Left Column: Payment Status, Paid Receipt No, Pre Print Receipt No */}
                ...
                {/* Right Column: Books for Class, Notes */}
                <div className="col-md-6">
                  <div className="mb-3">
                    <label htmlFor="booksForClass" className="form-label">Books for Class</label>
                    <Field
                      as="select"
                      id="booksForClass"
                      name="booksForClass"
                    ...
                    <ErrorMessage name="booksForClass" component="div" className="text-danger" />
                  </div>
